<footer class="container mx-auto bg-white py-8 border-t border-gray-400">
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16">
            <div class="text-center md:text-left">
                <img src="../imgs/logohotel" alt="logo do hotel" class="w-16 h-16">
            </div>
            <div class="text-center md:text-left">
                <h2 class="text-2xl font-bold mb-2">Navegação Rápida</h2>
                <div>
                    <li class="list-none">
                        <a href="/sobre" class="text-lg font-normal text-black ">Sobre Nós</a>
                    </li>

                    <li class="list-none">
                        <a href="/quartos" class="text-lg font-normal text-black ">Nossos Quartos</a>
                    </li>

                    <li class="list-none">
                        <a href="/cafe" class="text-lg font-normal text-black ">Café da Manhã</a>
                    </li>
                    
                    <li class="list-none">
                        <a href="/lazer" class="text-lg font-normal text-black ">Lazer</a>
                    </li>
                </div>
            </div>
            <div class="text-center md:text-left">
                ...
                <ul>
                    <li><a href="https://www.facebook.com/hotelconterraneomossoro/?locale=pt_BR" class="text-black mx-2"><i class="fab fa-facebook-f"></i>Facebook</a></li>
                    <li><a href="https://www.instagram.com/hotelconterraneooficial/" class="text-black mx-2"><i class="fab fa-instagram"></i>Instagram</a></li>
                    <li><a href="https://br.linkedin.com/company/hotel-conterr%C3%A2neo" class="text-black mx-2"><i class="fab fa-linkedin-in"></i>Linkedin</a></li>
                </ul>
            </div>
        </div>
